...
module.exports = {
    ...
    async isDev(member, bot) {
        ...
        try {
            ...
            let devGuild = bot.guilds.get("539779661425803265");
    ...
    async isAuthorId(author, authorID) {
        ...
        //if (await fcheck.isAuthorId(message.author, 'id') == 'false') return console.log('User not allowed to use this');
