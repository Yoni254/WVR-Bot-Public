...
module.exports = {
    ...
    execute(message, args, client, bot) {

        /** WVR Placement command
         * @param {object} message the message that was sent
         * @param {String} args the arguments of the command
         * @param {object} client the Data client - Redis to get data 
        ...
        try {
            ...
            if(message.member.hasPermission('MANAGE_ROLES') || message.member.roles.find(role => role.id === '562020358065225728')){
                ...
                /**Remove the Roles 
                 * @param {object} Recruit the User is being placed
                */
                ...
                */
                ...
                if(args[3] === 'Xbox' || args[3] === 'xbox' || args[3] === 'X' || args[3] === 'x' || args[3] === 'Xbox1' || args[3] === 'Xb1' || args[3] === 'xb1' || args[3] === 'xbox1'){
                    ...
                    bot.channels.get(`493444814717845504`).send('New '+roleName+' '+`${Recruit}`);
                    //Give Xbox Role
                    Recruit.roles.add(role);
                ...
                //Check if PS
                    ...
                    bot.channels.get(`533532176159997952`).send('New '+roleName+' '+`${Recruit}`);
                    //Give PS Role
                    Recruit.roles.add(role);
                ...
                //Check if PC
                    ...
                    bot.channels.get(`493436428911378442`).send('New '+roleName+' '+`${Recruit}`);
                    //Give PC Role
                    Recruit.roles.add(role);
                ...
                client.get(message.guild+'placedm', function(err, result) {
                    //Throw errors
                    if(err) throw err;
